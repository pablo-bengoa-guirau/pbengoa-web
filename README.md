...
*(The goal of this project is to develop a personal academic website to demonstrate HTML and CSS)*

The project follows a structured development process:

1.  **Design Analysis:** First, I selected a visual style based on professional software engineering portfolios (specifically inspired by Brittany Chiang), choosing a minimalist "Dark Mode" aesthetic.
...
* **Problem:** (Espacio para rellenar cuando lleguemos al CSS del menú...)
* **Solution:** ...
